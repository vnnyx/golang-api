...
func (_m *CustomerRepository) DeleteCustomer(ctx context.Context, customerId uint32) {
...
func (_m *CustomerRepository) GetCustomerById(ctx context.Context, customerId uint32) (entity.Customer, error) {
	ret := _m.Called(ctx, customerId)

	var r0 entity.Customer
	if rf, ok := ret.Get(0).(func(context.Context, uint32) entity.Customer); ok {
